...
<title>Capitalized and Lower to Lower kerns - Impallari Contextual Kerning Tool</title>
</head>

<body>
<h1>Capitalized and Lower to Lower kerns:</h1>
<?php 
...
print '<p>Showing '.count($resultado).' capitalized words having 5 or more kerning pairs each</p>';
